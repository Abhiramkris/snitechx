                    ...
                    <div class="cta-container">
                        ...
                        <button class="mobile-toggle" aria-label="Toggle menu">
                            <svg width="28" height="28" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <path class="line-middle" d="M4 12H20" stroke="black" stroke-width="2" stroke-linecap="round"/>
                                <path class="line-bottom" d="M4 18H20" stroke="black" stroke-width="2" stroke-linecap="round"/>
                            </svg>
                        </button>
                    </div>
                </div>
